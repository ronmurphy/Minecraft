...
=======
        self.world_type_grass = (YFlowers, WildGrass7, Rose, Fern, WildGrass6, Cactus, WildGrass5, TallCactus, WildGrass4, WildGrass3, WildGrass2, WildGrass1, WildGrass0)
        self.island_type_grass = (YFlowers, Rose, Fern, WildGrass7, WildGrass6, WildGrass5, WildGrass4, WildGrass3, WildGrass2, WildGrass1, WildGrass0)
        self.desert_type_grass = (DesertGrass, Cactus, DesertGrass, DesertGrass, TallCactus, DesertGrass, DesertGrass, DesertGrass, DesertGrass, DesertGrass, DesertGrass, DesertGrass,)
>>>>>>> more wildgrass types, desert grass
...
=======
                            ...
                            if self.rand.random() < G.TREE_CHANCE:
                                ...
                                if G.TERRAIN_CHOICE == "island":
                                    ...
                                    rndgrass = self_rand_choice(self.desert_type_grass)
                                else:
