...
class aservice(win32serviceutil.ServiceFramework):
   ...
   _svc_name_ = "pyCraftr"
   _svc_display_name_ = "pyCraftr Server Service"
   _svc_description_ = "Enables world_server.py to run as a service for pyCraftr in Windows."
   ...
   def SvcDoRun(self):
      ...
      while 1:
         ...
         if rc == win32event.WAIT_OBJECT_0:
            ...
            servicemanager.LogInfoMsg("pyCraftr server.py - STOPPED!")  #For Event Log
            break
         else:
                 ...
                 try:
                     file_path = "C:\Users\Brad\Documents\GitHub\Minecraft\server.bat 01234567890"
